...
COMPONENT_TEMPLATE_PATH = Path(__file__).parent.parent / "components"


def create_templates(*template_roots: Iterable[Path] | Path) -> Jinja2Templates:
    """
    Create a Jinja environment that can resolve both page templates and shared layout files.
    ...
    paths.append(COMPONENT_TEMPLATE_PATH)
